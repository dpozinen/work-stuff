...
public final class HeaderBuilder {
	...
	public HeaderBuilder add(HttpHeaderKey k, String v) {
		if (!header.contains(k) && StringUtils.isNotBlank(v))
			header.add(k, v);
		return this;
	}
	...
	public HeaderBuilder set(HttpHeaderKey k, String v) {
		if ( StringUtils.isNotBlank(v) && header.contains(k))
			header.set(k, v);
		return this;
	}
	...
	public HeaderBuilder referer(UriWrapper v) {
		return setOrAdd(HttpHeaderKey.Referer, String.valueOf(v));
	}

	public HeaderBuilder referer(Uri v) {
		return setOrAdd(HttpHeaderKey.Referer, String.valueOf(v));
	}
